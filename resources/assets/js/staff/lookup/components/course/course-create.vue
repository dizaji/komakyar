                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label for="input-title" class="col-sm-2 col-md-4 control-label">نام</label>
                                ...
                                <label for="input-multiplier" class="col-sm-2 col-md-4 control-label">ضریب</label>
                                <div class="col-sm-10 col-md-8">
                                    <input class="form-control"
                                           id="input-multiplier"
                                           placeholder="3"
                                           v-model="course.multiplier">
                                </div>
                            </div><div class="form-group">
                                <label for="input-reference-name" class="col-sm-2 col-md-4 control-label">نام منبع</label>
                                <div class="col-sm-10 col-md-8">
                                    <input class="form-control"
                                           id="input-reference-name"
                                           placeholder="فیزیک 1 و آزمایشگاه"
                                           v-model="course.reference_name">
                                </div>
                            </div>
                            <div class="form-group">
    ...
    export default {
        ...
        methods: {
            btnSaveClicked: function () {
                this.$Progress.start();
                this.errors = {};
                axios.post(route('staff.lookup.course.store'), removeNulls(this.course, true))
