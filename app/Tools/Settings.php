...
class Settings
{
    ...
    const PAGINATION_GROUP_PRESENTED_COURSE_LIMIT = self::PAGINATION_LIMIT_STAFF;
    ...
    const PAGINATION_LOOKUP_COURSE_PRESENTED_COURSE_LIMIT = self::PAGINATION_LIMIT_STAFF;
